    ...
    <breeze-authenticated-layout>
        ...
        <div class="py-12">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                ...
                <div class="grid grid-cols-3 md:grid-cols-2 sm:grid-cols-1 mobile:grid-cols-1">
                    <div v-for="list in contacts" class="max-w-md py-4 px-8 bg-white shadow-lg rounded-lg my-20 mx-10 sm:mx-20 mobile:mx-20">
