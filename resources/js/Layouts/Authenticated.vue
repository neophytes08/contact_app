                    ...
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                                ...
                                <breeze-nav-link :href="route('contacts.index')" :active="route().current('contacts.index')">
                                    Create Contacts
                                </breeze-nav-link>

                                <breeze-nav-link :href="route('notifications.index')" :active="route().current('notifications.index')">
